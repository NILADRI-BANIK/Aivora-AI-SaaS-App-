...
const RemoveObject = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post("/api/ai/remove-object", fromData, {
        headers: {
        ...
        >
          ...
          >
            ...
            {loading ? (
              ...
              <>
                <Scissors className="w-5 text-white relative z-10" />
          ...
          {!content ? (
            <div className="flex-1 flex justify-center items-center">
              <div className="flex flex-col items-center gap-5 text-gray-400">
                ...
                >
                  <Scissors className="w-10 h-10 text-[#E41E1E]" />
                </div>
            ...
            <div
              className="mt-3 flex-1 rounded-lg overflow-hidden border-2 border-[#E41E1E]/20"
              style={{
                boxShadow:
